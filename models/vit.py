...
class ViT(nn.Module):
    ...
    def forward(self, img):
        b, c, h, w = img.shape
        x = img.unfold(2, self.patch_height, self.patch_height).unfold(3, self.patch_width, self.patch_width)
        x = x.contiguous().view(b, -1, self.patch_height * self.patch_width * c)
