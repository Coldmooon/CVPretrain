...
@register_model()
def resnet18d(*, progress: bool = True, **kwargs: Any) -> ResNet:
    """
    Args:
...
@register_model()
def resnet34d(*, progress: bool = True, **kwargs: Any) -> ResNet:
    """
    Args:
        progress (bool, optional): If True, displays a progress bar of the
            download to stderr. Default is True.
...
@register_model()
def resnet50d(*, progress: bool = True, **kwargs: Any) -> ResNet:
    """
    Args:
        progress (bool, optional): If True, displays a progress bar of the
            download to stderr. Default is True.
...
@register_model()
def resnet101d(*, progress: bool = True, **kwargs: Any) -> ResNet:
    """
    Args:
        progress (bool, optional): If True, displays a progress bar of the
            download to stderr. Default is True.
...
@register_model()
def resnet152d(*, progress: bool = True, **kwargs: Any) -> ResNet:
    """
    Args:
        progress (bool, optional): If True, displays a progress bar of the
            download to stderr. Default is True.
